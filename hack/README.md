## For insight, only generate individual dashboards under "charts/insight/charts/grafana-dashboard/templates/dashboards", those dashboards under independent folder like /hwamei, /jvm is maintained by hand. 
